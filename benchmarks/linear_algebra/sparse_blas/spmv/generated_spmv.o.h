#ifndef HALIDE__generated_spmv_o_h
#define HALIDE__generated_spmv_o_h
#include <stdint.h>
...
int spmv(struct halide_buffer_t *_b_SIZES_buffer, struct halide_buffer_t *_b_row_start_buffer, struct halide_buffer_t *_b_col_idx_buffer, struct halide_buffer_t *_b_values_buffer, struct halide_buffer_t *_b_x_buffer, struct halide_buffer_t *_b_y_buffer) HALIDE_FUNCTION_ATTRS;
int spmv_old_buffer_t(struct buffer_t *_b_SIZES, struct buffer_t *_b_row_start, struct buffer_t *_b_col_idx, struct buffer_t *_b_values, struct buffer_t *_b_x, struct buffer_t *_b_y) HALIDE_FUNCTION_ATTRS;
