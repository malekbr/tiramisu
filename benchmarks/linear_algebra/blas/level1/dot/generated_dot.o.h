#ifndef HALIDE__generated_dot_o_h
#define HALIDE__generated_dot_o_h
#include <stdint.h>
...
int dot(struct halide_buffer_t *_b_SIZES_buffer, struct halide_buffer_t *_b_x_buffer, struct halide_buffer_t *_b_y_buffer, struct halide_buffer_t *_b_res_global_buffer) HALIDE_FUNCTION_ATTRS;
int dot_old_buffer_t(struct buffer_t *_b_SIZES, struct buffer_t *_b_x, struct buffer_t *_b_y, struct buffer_t *_b_res_global) HALIDE_FUNCTION_ATTRS;
