#ifndef HALIDE__generated_dot_gpu_o_h
#define HALIDE__generated_dot_gpu_o_h
#include <stdint.h>
...
int dot_gpu(struct halide_buffer_t *_sizes_host_buffer, struct halide_buffer_t *_x_host_buffer, struct halide_buffer_t *_y_host_buffer, struct halide_buffer_t *_result_host_buffer) HALIDE_FUNCTION_ATTRS;
int dot_gpu_old_buffer_t(struct buffer_t *_sizes_host, struct buffer_t *_x_host, struct buffer_t *_y_host, struct buffer_t *_result_host) HALIDE_FUNCTION_ATTRS;
