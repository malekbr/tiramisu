#ifndef HALIDE__generated_cg_o_h
#define HALIDE__generated_cg_o_h
#include <stdint.h>
...
int cg(struct halide_buffer_t *_b_SIZES_buffer, struct halide_buffer_t *_b_alpha_buffer, struct halide_buffer_t *_b_x_buffer, struct halide_buffer_t *_b_beta_buffer, struct halide_buffer_t *_b_y_buffer, struct halide_buffer_t *_b_w_buffer, struct halide_buffer_t *_b_row_start_buffer, struct halide_buffer_t *_b_col_idx_buffer, struct halide_buffer_t *_b_values_buffer, struct halide_buffer_t *_b_spmv_buffer, struct halide_buffer_t *_b_res_global_buffer) HALIDE_FUNCTION_ATTRS;
int cg_old_buffer_t(struct buffer_t *_b_SIZES, struct buffer_t *_b_alpha, struct buffer_t *_b_x, struct buffer_t *_b_beta, struct buffer_t *_b_y, struct buffer_t *_b_w, struct buffer_t *_b_row_start, struct buffer_t *_b_col_idx, struct buffer_t *_b_values, struct buffer_t *_b_spmv, struct buffer_t *_b_res_global) HALIDE_FUNCTION_ATTRS;
