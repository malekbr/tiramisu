...
tiramisu::expr generator::linearize_access(int dims, std::vector<tiramisu::expr> &strides, std::vector<tiramisu::expr> index_expr)
{
    ...
    tiramisu::expr index = caster<int>::cast(0, global::get_loop_iterator_default_data_type());
                                         ...
                                         const tiramisu::expr *expr)
{
    ...
    tiramisu::expr stride = caster<int>::cast(1, global::get_loop_iterator_default_data_type());
